...
const CourseChapter = () => {
  ...
  return (
    <div className="text-gray-50 w-full flex flex-col items-center">
      ...
      <div className="relative bg-gray-800 rounded-lg shadow-lg overflow-hidden mx-auto max-w-8xl w-full flex justify-center items-center">
        <ReactPlayer
      ...
      {/* Chapter Details */}
      <div className="mt-8 bg-gray-700 rounded-lg shadow-lg p-6 w-full max-w-5xl">
