    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1501504905252-473c47e087f8?q=80&w=2074')",
        ...
        <div className="relative p-12 flex flex-col h-full z-10">
          ...
          <div className="my-auto max-w-lg">
            ...
            <p className="text-lg mb-10 text-slate-300 leading-relaxed">
              Create a strong password to protect your account and continue your learning journey.
            </p>
            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-white text-lg mb-1">Strong Password</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">Use a combination of letters, numbers, and special characters for security.</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="bg-emerald-500/20 rounded-full p-2 mr-4 mt-0.5">
                ...
                <div>
                  <h3 className="font-medium text-white text-lg mb-1">Unique Password</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">Create a unique password that you don't use for other websites.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 bg-white">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Reset your password</h2>
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <div>
              <InputLabel htmlFor="password" value="New Password" className="text-slate-700 font-medium" />
              <TextInput
                id="password"
                type="password"
                name="password"
