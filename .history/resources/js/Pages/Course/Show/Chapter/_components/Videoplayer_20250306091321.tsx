...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ src, chapter, nextChapterId, previousChapterId, isCompleted }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
      className="relative w-full max-w-full bg-red-600 h-full"
    >
      <div className="h-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 p-2 flex items-center z-[9999]">
          <Button
            size={'sm'}
            onClick={togglePlayPause}
            className="mr-2"
