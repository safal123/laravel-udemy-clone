  ...
  return (
    <div className="relative group" ref={containerRef}>
      ...
      {showQualities && (
        <div
          className={cn(
            "absolute bg-black/95 rounded-lg shadow-xl border border-white/10 min-w-[220px] py-1 z-50",
            isMobile ?
        ...
        >
          ...
          <div
            className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-red-600/50 cursor-pointer"
            onClick={() => {
