        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 p-2 flex items-center z-[99998]">
          ...
          <input
            ...
            className="flex-1 cursor-pointer appearance-none bg-transparent
              ...
              [&::-webkit-slider-runnable-track]:from-[length:var(--progress)]
              [&::-webkit-slider-runnable-track]:via-blue-400
              [&::-webkit-slider-runnable-track]:via-[length:var(--buffered)]
              [&::-webkit-slider-runnable-track]:to-gray-300
              [&::-webkit-slider-runnable-track]:to-[length:var(--remainder)]
              ...
              [&::-moz-range-track]:from-[length:var(--progress)]
              [&::-moz-range-track]:via-blue-400
              [&::-moz-range-track]:via-[length:var(--buffered)]
              [&::-moz-range-track]:to-gray-300
              [&::-moz-range-track]:to-[length:var(--remainder)]
              [&::-moz-range-track]:h-1
            ...
            style={{
              ...
              '--buffered': `${((bufferedTime - currentTime) / duration) * 100}%`,
              '--remainder': `${100 - (bufferedTime / duration) * 100}%`
