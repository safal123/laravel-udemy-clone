...
import { PlayIcon, PauseIcon, Maximize2Icon, Minimize2Icon, PictureInPicture2Icon, CheckCircle2Icon, ChevronLeft, ChevronRight } from 'lucide-react'
        ...
        <div className="flex items-center gap-4 px-2">
          ...
          <div className="flex-1 flex items-center justify-center gap-4">
            <Button
              ...
              className="text-white hover:bg-red-600 rounded-full w-10 h-10 flex items-center justify-center transition-all duration-200 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <Button
              ...
              className={cn(
                "text-white rounded-full h-10 px-4 flex items-center gap-2 transition-all duration-200 hover:scale-105",
                isCompleted ? "bg-green-600" : "hover:bg-red-600"
              )}
            >
