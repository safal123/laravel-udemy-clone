...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ src, chapter, nextChapterId, previousChapterId, isCompleted }) => {
  ...
  // Update the protection functions
  ...
  return (
    <div
      ref={containerRef}
      className="group relative w-full max-w-full h-full bg-black select-none"
      onContextMenu={(e) => e.preventDefault()}
      onDoubleClick={toggleFullScreen}
    >
      <div
        ref={videoContainerRef}
        className="h-full relative group video-protected"
        style={{
      ...
      >
        <video
          ...
          className={cn(
            "w-full h-full aspect-video object-cover cursor-pointer",
            isBlurred && "blur-xl"
          )}
          style={{
            WebkitUserSelect: 'none',
        ...
        <div
          ...
          style={{
            ...
            userSelect: 'none',
            WebkitTouchCallout: 'none',
            pointerEvents: isProtected ? 'auto' : 'none',
          }}
          onClick={togglePlayPause}
        />
