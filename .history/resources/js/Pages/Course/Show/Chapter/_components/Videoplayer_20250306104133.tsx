...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ src, chapter, nextChapterId, previousChapterId, isCompleted }) => {
  ...
  // Add these event handlers to prevent screenshots and right-clicks
  ...
  // Add this useEffect to handle the events
  useEffect(() => {
    // Add event listeners
    ...
    >
      ...
      <div className="h-full relative group">
        <video
          ...
          onContextMenu={(e) => e.preventDefault()} // Prevent right-click on video
        ...
        {/* Add an overlay div to prevent selection */}
        <div
