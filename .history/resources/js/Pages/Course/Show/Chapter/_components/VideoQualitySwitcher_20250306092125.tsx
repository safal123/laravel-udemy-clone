    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="text-white bg-black bg-opacity-70 rounded-full hover:bg-opacity-90 transition-opacity relative z-[99999]"
        >
      ...
      <DropdownMenuContent
        className="bg-black bg-opacity-90 border-none text-white relative z-[999999]"
        align="end"
        sideOffset={5}
      >
        <DropdownMenuItem
