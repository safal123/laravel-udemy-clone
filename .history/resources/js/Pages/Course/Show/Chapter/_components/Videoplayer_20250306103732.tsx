...
import { CheckCircle2Icon, ChevronLeft, ChevronRight, PlayIcon, PauseIcon, Maximize2Icon, Minimize2Icon, PictureInPicture2Icon } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="h-full relative group">
        ...
        {/* Controls overlay */}
        <div
          className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-200"
        >
          <div className="p-4 space-y-4">
            {/* Progress bar container */}
            <div
              ref={progressBarRef}
              className="relative w-full h-1 group/progress cursor-pointer hover:h-1.5 transition-all"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="ml-auto flex items-center gap-2">
                ...
                <Button
                  ...
                  className="text-white hover:bg-white/10 rounded-full w-10 h-10 flex items-center justify-center transition-all duration-200"
                >
