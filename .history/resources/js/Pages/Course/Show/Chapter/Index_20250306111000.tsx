      ...
      <div className="w-full flex items-center justify-between px-4 py-3 border-b">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="sm"
            disabled={!chapter.pre}
            onClick={() => router.visit(`/courses/${chapter.course.slug}/chapters/${chapter.previousChapterId}`)}
          ...
          <Button
            ...
            onClick={() => router.visit(`/courses/${chapter.course.slug}/chapters/${chapter.nextChapterId}`)}
            className="text-muted-foreground hover:text-foreground transition-colors"
          >
            Next Chapter
